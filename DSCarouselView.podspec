#
#  Be sure to run `pod spec lint DSCarouselView.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "DaShen"
  # s.authors            = { "DaShen" => "1057105719@qq.com" }
  # s.social_media_url   = "http://twitter.com/DaShen"
  ...
  s.source       = { :git => "https://github.com/ludaye123/DSCarouselView.git", :tag => "1.1.6" }
  ...
  #
    ...
    s.resources = 'DSCarouselViewDemo/DSCarouselViewDemo/DSCarouselView/*.{png,xib}'
